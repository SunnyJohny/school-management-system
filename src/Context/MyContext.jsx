          ...
          <>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-4">
              {filteredTeachers.map((teacher) => (
                <div key={teacher.id} className="bg-white shadow-lg rounded-md p-6 hover:shadow-xl transition-shadow">
                  <div className="text-center flex flex-col items-center cursor-pointer">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-4">
              {filteredClasses.map((classItem) => (
                <div key={classItem.id} className="bg-white shadow-lg rounded-md p-6 hover:shadow-xl transition-shadow">
                  <div className="text-center flex flex-col items-center cursor-pointer">
                    <p className="text-lg font-bold text-blue-600">{classItem.name}</p> {/* Colored name */}
                    <p className="text-sm text-green-500">
                      Students: {classItem.studentCount}
                    </p> {/* Colored student count */}
                  </div>
                </div>
              ))}
            </div>
